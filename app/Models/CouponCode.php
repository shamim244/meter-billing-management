...
class CouponCode extends Model
{
    ...
    /**
     * Referrer owner of this referral code (if type = 'referral').
     */
    ...
    /**
     * Referral payouts generated by this coupon code.
     */
    public function referralPayouts(): HasMany
    {
        return $this->hasMany(ReferralPayout::class, 'referral_coupon_code_id');
    }
