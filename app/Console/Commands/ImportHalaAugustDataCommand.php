...
class ImportHalaAugustDataCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:hala-august 
     ...
     * @var string
     */
    protected $description = 'Import August working readings and statuses for Hala (0473) from migration directory';
    ...
    public function handle(): int
    {
        ...
        $baseDir = base_path('.agents/docs/Migrate/Hala-0473');
        ...
        $this->info("Starting Hala August migration for User #{$user->id} ({$user->email})...");
